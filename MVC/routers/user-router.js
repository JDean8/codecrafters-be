...
const {
  ...
  getEventCreatedByEvent_Id,
  deleteEventCreatedByEvent_Id,
} = require("../controllers/eventsCreatedController");
...
userRouter
  .route("/:user_id/my-events/:event_id")
  .get(getEventCreatedByEvent_Id)
  .delete(deleteEventCreatedByEvent_Id);
